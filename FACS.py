...
# width: [Integer] describing the width of the graph
# height: [Integer] describing the height of the graph
# y lim: [Tuple] of the range of the y limits
# x lim: [Tuple] of the range of the x limits
# x axis: [Boolean] referring to the presence of the x-axis label
...
#%%
# function to make FACS graphs in portrait mode
# files: [list] of fcs file paths (str)
# labels: [list] of Labels for each sample (str)
# colour: [list] of colours to be assigned for the respective sample
